...
/***************************************************** Inicio Sintactico ****************************************************/
  ...
  final public boolean INICIO(int nA1,int nS1,boolean valido1,String numeros1) throws ParseException {
    int nA =0, nS=0;
    boolean valido= valido1,validoA=true;
    Token n;
    String numeros=numeros1;
    n = jj_consume_token(numero);
        nA=nS1;
        nS= Integer.parseInt(n.image);
    validoA = SIGUIENTE(nA,nS,valido,numeros);
        {if (true) return validoA;}
    throw new Error("Missing return statement in function");
  }

  final public boolean SIGUIENTE(int nA1,int nS1,boolean valido1,String numeros1) throws ParseException {
    int nA =nA1, nS=nS1;
    boolean valido= valido1,validoA=true;
    String numeros=numeros1;
